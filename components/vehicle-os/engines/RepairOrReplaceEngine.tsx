...
export function RepairOrReplaceEngine() {
        ...
        <div className="bg-white border-2 border-slate-900 rounded-3xl p-6 shadow-md space-y-5">
          ...
          <p className="text-xs text-slate-600 leading-relaxed font-medium">
            {repairIsCheaper
              ...
              : `Because your repair bill is ~${Math.round((repairEstimate / (currentCarValue || 1)) * 100)}% of the vehicle's market value, sinking money into it is uneconomical. Upgrading to a newer vehicle with fresh warranty makes more financial sense.`}
          </p>

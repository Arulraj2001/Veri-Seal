...
export function CostRealityCheckerEngine() {
    ...
    <div className="space-y-6">
      ...
      <div className="bg-slate-50 border border-slate-200/90 rounded-2xl p-4 flex flex-col sm:flex-row sm:items-center gap-3">
        ...
        <select
          ...
          className="w-full sm:w-80 bg-white border border-slate-200 rounded-xl px-3.5 py-2 text-xs font-bold text-slate-900 focus:outline-none focus:ring-2 focus:ring-amber-500"
        >

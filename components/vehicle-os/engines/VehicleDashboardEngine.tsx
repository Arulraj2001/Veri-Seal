...
export function VehicleDashboardEngine() {
  ...
  return (
    <div className="space-y-6">
      {/* Top Controls Bar */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-slate-50 border border-slate-200/90 rounded-2xl p-4">
        <div className="text-xs font-bold text-slate-600">
          {vehicles.length > 0 ? (
            <span>Active Vehicle Profile: <strong className="text-slate-900">{currentVehicle?.nickname}</strong></span>
          ) : (
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-xs font-bold text-slate-500 flex items-center gap-2 mt-0.5">
                    ...
                    <span>•</span>
                    <span className="font-mono text-slate-700">{currentVehicle.registrationNumber || 'KA 01 MJ 5821'}</span>
                  </div>
                </div>
              </div>
            ...
            <form onSubmit={handleAddVehicle} className="space-y-3 text-xs">
              ...
              <div className="flex items-center justify-end gap-2 pt-2 border-t border-slate-100">
                <button
                  ...
                  className="px-3 py-2 text-slate-600 hover:text-slate-900 font-bold cursor-pointer"
                >
                  Cancel
                </button>
                <button

...
export default function ServiceQuoteFairnessEngine() {
  ...
  return (
    <div className="space-y-8">
      {/* Vehicle & Workshop Selector Card */}
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white border border-slate-200/90 rounded-3xl p-5 shadow-sm space-y-4">
            ...
            <form onSubmit={handleAddItem} className="pt-3 border-t border-slate-100 flex flex-col sm:flex-row items-center gap-2">
              ...
              <button
                type="submit"
                className="w-full sm:w-auto px-4 py-2 bg-amber-600 hover:bg-amber-700 text-white text-xs font-bold rounded-xl shadow-xs transition-colors flex items-center justify-center gap-1 shrink-0 cursor-pointer"
              >

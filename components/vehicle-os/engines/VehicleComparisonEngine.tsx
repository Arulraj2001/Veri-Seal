...
export function VehicleComparisonEngine() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-slate-50 border border-slate-200/90 rounded-2xl p-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
          ...
          <select
            ...
            className="w-full bg-white border border-slate-200 rounded-xl px-3.5 py-2.5 text-xs font-bold text-slate-900"
          >

...
export function AffordabilityCheckerEngine() {
  ...
  return (
    <div className="space-y-6">
      {/* Preset Selector */}
      <div className="bg-slate-50 border border-slate-200/90 rounded-2xl p-4 flex flex-col sm:flex-row sm:items-center gap-3">
        ...
        <select
          ...
          className="w-full sm:w-80 bg-white border border-slate-200 rounded-xl px-3.5 py-2 text-xs font-bold text-slate-900"
        >
            ...
            <div className="text-xs text-slate-700 leading-relaxed font-medium">
              {isStretch ? (
                <div className="bg-red-50 border border-red-200 p-3.5 rounded-2xl text-red-800 space-y-1">
                  ...
                  <p>
                    This vehicle will consume <strong>{Math.round((trueMonthlyCost / (monthlyTakeHomeIncome || 1)) * 100)}%</strong> of your take-home salary. Financial planners recommend keeping total transport under 20%. Consider a higher down payment or a 1-tier lower vehicle model.
                  </p>
                </div>
              ) : (
                <div className="bg-emerald-50 border border-emerald-200 p-3.5 rounded-2xl text-emerald-800 space-y-1">
                  ...
                  <p>
                    This vehicle represents only <strong>{Math.round((trueMonthlyCost / (monthlyTakeHomeIncome || 1)) * 100)}%</strong> of your monthly take-home salary, leaving your emergency savings and life goals uncompromised.
                  </p>
                </div>
              )}
            </div>

...
export default function ServiceInvoiceAnalyzerEngine() {
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-white border border-slate-200/90 rounded-3xl p-5 shadow-sm space-y-4">
            ...
            <form onSubmit={handleAddItem} className="pt-3 border-t border-slate-100 grid grid-cols-1 sm:grid-cols-12 gap-2">
              ...
              <button
                type="submit"
                className="sm:col-span-1 p-2 bg-amber-600 hover:bg-amber-700 text-white rounded-xl shadow-xs flex items-center justify-center transition-colors cursor-pointer"
                title="Add item"
              >
        ...
        <div className="space-y-6">
          <div className="bg-white border border-slate-200/90 rounded-3xl p-6 shadow-sm space-y-4">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-slate-900 hover:bg-slate-800 text-white font-bold text-xs rounded-2xl shadow-xs transition-colors cursor-pointer"
            >
              {savedSuccess ? (
                <>

  ...
  return (
    <div className="min-h-screen bg-background bg-dot-grid text-text-main pt-28 pb-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="bg-slate-900/80 border border-slate-800 rounded-2xl p-2 backdrop-blur-xl shadow-lg flex items-center gap-1.5 overflow-x-auto scrollbar-thin">
          {SUB_NAV_LINKS.map((link) => {
            ...
            return (
              <Link
                key={link.href}
                href={link.href}
                className="flex items-center gap-2 px-3.5 py-2 rounded-xl text-xs font-semibold text-slate-300 hover:text-white hover:bg-slate-800/80 whitespace-nowrap transition-colors"
              >

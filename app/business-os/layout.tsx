...
const SUB_NAV_LINKS = [
  ...
  { href: '/business-os/real-profit-calculator', label: 'Real P&L Leaks', icon: TrendingUp },
  { href: '/business-os/product-pricing-calculator', label: 'Product Pricing', icon: Tag },

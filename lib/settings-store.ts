...
export const inMemorySettings: Record<string, string> = {
  ...
  free_daily_limit: '3',
  admin_notification_email: 'admin@Kagazo.in',
...
export async function getMergedSettings(): Promise<SiteSettings> {
  ...
  return {
    ...
    upi_id: result['upi_id'] || 'Kagazo.pay@icici',
    upi_qr_url: result['upi_qr_url'] || 'https://Kagazo.in/assets/upi-qr-sample.png',
    pro_price: parseInt(result['pro_price'] || '199', 10),
    business_price: parseInt(result['business_price'] || '2499', 10),
    site_name: result['site_name'] || 'Kagazo',
    site_tagline: result['site_tagline'] || 'Verify Indian Government PDF Digital Signatures Online',
    contact_email: result['contact_email'] || 'support@Kagazo.in',
    ...
    sponsor_cta_url: result['sponsor_cta_url'] || 'https://Kagazo.in/blog',

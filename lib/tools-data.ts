...
export const TOOL_CATEGORIES: ToolCategory[] = [
  ...
  {
    id: 'cyber_cafe',
    label: 'Photo Studio & Cyber Cafe Suite',
    description: 'Zero-Photoshop studio web apps: 4x6 photo sheets, formal suit changer, biometric face aligner, and DOP date stamper.',
    iconName: 'Camera',
  },
  {
    id: 'verification',
...
export const TOOLS_CATALOG: ToolItem[] = [
  ...
  // -------------------------------------------------------------
  {
    ...
    category: 'cyber_cafe',
    categoryLabel: 'Photo Studio & Cyber Cafe',
